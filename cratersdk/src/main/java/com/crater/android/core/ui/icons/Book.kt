...
public val CraterIcons.Book: ImageVector
    get() {
        if (_book != null) {
            return _book!!
        }
        _book = Builder(name = "Book", defaultWidth = 17.0.dp, defaultHeight = 81.0.dp,
                viewportWidth = 17.0f, viewportHeight = 81.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(12.5303f)
                close()
            }
            path(fill = SolidColor(Color(0xFF0D0D0D)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(15.5f, 65.3346f)
                horizontalLineTo(3.8333f)
                curveTo(3.3913f, 65.3346f, 2.9674f, 65.5102f, 2.6548f, 65.8228f)
                curveTo(2.3423f, 66.1354f, 2.1667f, 66.5593f, 2.1667f, 67.0013f)
                curveTo(2.1667f, 67.4433f, 2.3423f, 67.8673f, 2.6548f, 68.1798f)
                curveTo(2.9674f, 68.4924f, 3.3913f, 68.668f, 3.8333f, 68.668f)
                horizontalLineTo(15.5f)
                verticalLineTo(79.5013f)
                curveTo(15.5f, 79.7223f, 15.4122f, 79.9343f, 15.2559f, 80.0906f)
                curveTo(15.0996f, 80.2468f, 14.8877f, 80.3346f, 14.6667f, 80.3346f)
                horizontalLineTo(3.8333f)
                curveTo(2.9493f, 80.3346f, 2.1014f, 79.9834f, 1.4763f, 79.3583f)
                curveTo(0.8512f, 78.7332f, 0.5f, 77.8854f, 0.5f, 77.0013f)
                verticalLineTo(67.0013f)
                curveTo(0.5f, 66.1172f, 0.8512f, 65.2694f, 1.4763f, 64.6443f)
                curveTo(2.1014f, 64.0192f, 2.9493f, 63.668f, 3.8333f, 63.668f)
                horizontalLineTo(14.6667f)
                curveTo(14.8877f, 63.668f, 15.0996f, 63.7558f, 15.2559f, 63.912f)
                curveTo(15.4122f, 64.0683f, 15.5f, 64.2803f, 15.5f, 64.5013f)
                verticalLineTo(65.3346f)
                close()
                moveTo(2.1667f, 77.0013f)
                curveTo(2.1667f, 77.4433f, 2.3423f, 77.8673f, 2.6548f, 78.1798f)
                curveTo(2.9674f, 78.4924f, 3.3913f, 78.668f, 3.8333f, 78.668f)
                horizontalLineTo(13.8333f)
                verticalLineTo(70.3346f)
                horizontalLineTo(3.8333f)
                curveTo(3.2482f, 70.3356f, 2.6732f, 70.1818f, 2.1667f, 69.8888f)
                verticalLineTo(77.0013f)
                close()
                moveTo(14.6667f, 67.8346f)
                horizontalLineTo(3.8333f)
                curveTo(3.6123f, 67.8346f, 3.4004f, 67.7468f, 3.2441f, 67.5906f)
                curveTo(3.0878f, 67.4343f, 3.0f, 67.2223f, 3.0f, 67.0013f)
                curveTo(3.0f, 66.7803f, 3.0878f, 66.5683f, 3.2441f, 66.412f)
                curveTo(3.4004f, 66.2558f, 3.6123f, 66.168f, 3.8333f, 66.168f)
                horizontalLineTo(14.6667f)
                verticalLineTo(67.8346f)
                close()
            }
        }
        .build()
